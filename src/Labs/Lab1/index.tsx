    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Wash and drain rice 3 times.</li>
          <li>Cook rice in rice-cooker.</li>
          <li>Slice spam and fry until browning in pan.</li>
          <li>Put spam to the side and cook egg in pan.</li>
          <li>Put rice in bowl with spam and egg on top.</li>
          <li>Serve with kimchi and seaweed.</li>
          <li>Enjoy!</li>
        </ol>
        ...
        <ul id="wd-your-books">
          ...
          <li>The Mandolorian, The Stormtrooper, and their Son</li>
          <li>Song of Achilles</li>
          <li>Cafune</li>
        </ul>
      </div>
      <div id="wd-tables">
      ...
      <a
        id="wd-github"
        href="https://github.com/123Jellybean/kanbas-react-web-app"
      >
        Github Link
      </a>
    </div>
